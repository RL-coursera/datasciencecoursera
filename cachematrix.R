#cachematrix.R ---> by R Levine


##This function \ makeCacheMatrix takes a matrix as an input, set the value of the matrix,
...
####Test 2 [2*2 Matrix] #####
TestMatrix <- matrix(c(4,5,1,2),2,2)
TestMatrix
...
####Test 3 [3*3 Matrix] #####
#matrix(1:9,3,3) is not invertible
...
####Test 4 [3*3 Matrix]#####
TestMatrix <- matrix(c(1,2,3,4,5,6,7,8,0),3,3)
TestMatrix
